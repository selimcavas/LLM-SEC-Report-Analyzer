...
from tool.tools import transcript_analyze_tool, text2sql_tool, stock_prices_visualizer_tool, compare_cumulative_returns_tool
...
def run_main_agent(user_question, chat_history):
    ...
    tool_list = [transcript_analyze_tool,
                 ...
                 compare_cumulative_returns_tool]
